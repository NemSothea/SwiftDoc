...
class TodoCell: UITableViewCell {
    ...
    private func setupActions() {
        ...
        // Add long press gesture for quick actions
    ...
    @objc private func statusButtonTapped(_ sender: UIButton) {
        ...
        delegate?.todoCellDidToggleStatus(self, for: todo)
    ...
    @objc private func handleLongPress(_ gesture: UILongPressGestureRecognizer) {
        guard gesture.state == .began, let todo = currentTodo else { return }
        
        // Add haptic feedback
        let impactFeedback = UIImpactFeedbackGenerator(style: .medium)
        impactFeedback.impactOccurred()
        
        // Notify delegate about long press
        delegate?.todoCellDidToggleStatus(self, for: todo)
    }
    
    // MARK: - Configuration
    func configure(with todo: TodoItem) {
        // Store the current todo
        currentTodo = todo
        ...
        updateAppearance(for: todo, title: todo.title)
